...
use App\Filament\Exports\Employees\DeductionExporter;
        ...
        return $table
            ...
            ->headerActions([
                ExportAction::make('export')
                    ...
                    ->exporter(DeductionExporter::class),
            ])
            ->actions([
                ActionGroup::make([
                    ViewAction::make('viewDetails')
                        ...
                        ->form([
                            Section::make([
                                ...
                                ->columns(2)
                                ->description(__("panels.the_deduction_will_be_applied_to_the_employee's_net_salary"))
